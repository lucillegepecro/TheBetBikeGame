...
public class JcDecauxServlet extends HttpServlet {
	...
	public void doGet(HttpServletRequest req, HttpServletResponse resp)  
		...
		// pour chaque ville, r�cup�rer la liste des stations avec leur nb de v�los emprunt�s
		for (int i=0 ; i<villes.size() ; i++){
			country = villes.get(i);
			
			String url_km = "https://api.jcdecaux.com/vls/v1/stations?contract="+ country + "&apiKey=" + apikey;
			
			// r�cup�re le flux json des velos emprunt�s par ville
	...
	public String connection (String urlJcdecaux){
		...
		String inputLine;
		String source = "";
		// On remplit le String retourn� avec les infos r�cup�r�es
		try {
		if (in != null) {
